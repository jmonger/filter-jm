...
insert into users (id, firstname, surname, role, age) values (1, 'Arline', 'Dresse', 'Web Designer III', 100);
insert into users (id, firstname, surname, role, age) values (2, 'Glory', 'Walton', 'Tax Accountant', 41);
insert into users (id, firstname, surname, role, age) values (3, 'Morly', 'Queyos', 'Electrical Engineer', 88);
insert into users (id, firstname, surname, role, age) values (4, 'Moss', 'Sobey', 'Pharmacist', 63);
